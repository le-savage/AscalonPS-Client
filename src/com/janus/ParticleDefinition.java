...
public class ParticleDefinition {
    ...
    public static ParticleDefinition[] cache = new ParticleDefinition[]{
            ...
            new ParticleDefinition() {
                { //13
                    //Red Dragonfire Shield Eyes
                    setStartVelocity(new ParticleVector(1, 0, 0));
                    setEndVelocity(new ParticleVector(1, 0, 0));
                    setGravity(new ParticleVector(3, 0, 0));
                    setLifeSpan(19);
                    setStartColor(0xE83B0C);
                    setSpawnRate(3);
                    setStartSize(1f);
                    setEndSize(0);
                    setStartAlpha(0.035f);
