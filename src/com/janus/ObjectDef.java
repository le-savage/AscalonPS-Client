...
public final class ObjectDef {
    ...
    private static final int[] OBJECTS_OSRS = {
            ...
            23108, 23109, 23112, 23610, 26294, 6775, 27059, 27059, 26765, 11698, 11699, 11700,
    ...
    public static ObjectDef forID(int i) {
		...
		/*if((i == 56031) || (i == 56032) || (i == 56034)) {
			objectDef.name = "Fiery Furnace";
			objectDef.actions = new String[] {"Smelt", "Jewellery", null, null, null};
		}*/
        if (i == 591) {
            objectDef.actions = new String[5];
            objectDef.actions[0] = "Use";
            objectDef.objectModelIDs = new int[]{23322};
        }
        if (i == 5259) {
            objectDef.actions = new String[5];
        ...
        if (i == 884) {
            objectDef.actions = new String[]{"Investigate", null, null, null, null};
            objectDef.name = "Well of Goodwill";
        }
        if (i == 880) {//New Fountain of Good Will
            objectDef.actions = new String[]{"Investigate", null, null, null, null};
            objectDef.name = "Fountain of Goodwill";
        }
        if (i == 11601) {//Jewellery
            objectDef.actions = new String[]{"Make Jewellery", null, null, null, null};
            objectDef.name = "Red Hot Foundry";
        }
        ...
        if (i == 6045) {
            objectDef.actions = new String[5];
            objectDef.actions[0] = "Deposit Inventory";
            objectDef.name = "Mining Cart";
        }
        /** NEW AFK ZONE **/
        if (i == 17783 || i == 17782 || i == 17784) {//wall
            objectDef.name = "Wall";
        }

		/*if(i == 49522) {//COOK & FISH
			//objectDef.actions = new String[] {"Afk Fishing", "Afk Cooking", null, null, null};
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Afk Fishing";
			objectDef.actions[1] = "Afk Cooking";
			objectDef.name = "Crate of Fish";
		}*/
        if (i == 54259) {//SMITHING
            objectDef.actions = new String[]{"Afk Smithing", null, null, null, null};
            objectDef.name = "Training Anvil";
        }
        if (i == 19336) {//HUNTER
            objectDef.actions = new String[]{"Afk Hunter", null, null, null, null};
            objectDef.name = "Bird Snare";
        }
        if (i == 36959) {//COMBAT
            objectDef.actions = new String[]{"Afk Attack", "Afk Magic", null, null, null};
            objectDef.name = "Combat Dummy";
        }
        if (i == 2023) {//WOODCUTTING
            objectDef.actions = new String[]{"Afk Woodcuting", null, null, null, null};
            objectDef.name = "Ancient Tree";
        }
        if (i == 5896) {//MINING
            objectDef.actions = new String[]{"Afk Mining", null, null, null, null};
            objectDef.name = "Rock Tower";
        }
        if (i == 56859) {//THIEVING
            objectDef.actions = new String[]{"Afk Thieveing", null, null, null, null};
            objectDef.name = "Thieving Stall";
        }
        if (i == 49536) {//FLETCHING & FIREMAKING
            objectDef.actions = new String[]{"Afk Fletching", "Afk Firemaking", null, null, null};
            objectDef.name = "Crate of logs";
        }
        ...
        switch (i) {
            ...
            case 56034:
                ...
                objectDef.name = "Fiery Furnace";
                objectDef.description = "I need to be careful when smeling on here!".getBytes();
                break;

            case 38144:
                objectDef.hasActions = true;
                objectDef.actions = new String[]{"Select", null, null, null, null};
                objectDef.name = "Instance";
                objectDef.description = "I can fight loads of NPC's here!".getBytes();
                break;

            case 24600:
                objectDef.hasActions = true;
                objectDef.actions = new String[]{"Exit", null, null, null, null};
                objectDef.name = "Button";
                objectDef.description = "I can leave my instance here!".getBytes();
                break;
            ...
            case 4306:
                objectDef.actions = new String[5];
                objectDef.actions[0] = "Use";
                objectDef.objectModelIDs = new int[]{23436};
                objectDef.name = "Golden Anvil";
                objectDef.description = "Careful not to scratch it!".getBytes();
                break;

            case 9391:
                objectDef.actions = new String[5];
                objectDef.actions[0] = "Use";
                objectDef.name = "Difficulty Selector";
                objectDef.description = "I can change my difficulty using this!".getBytes();
                break;
            case 38828:
                objectDef.actions = new String[5];
                objectDef.actions[0] = "Add Logs";
                objectDef.name = "Blazing Fire";
                objectDef.description = "I should add logs to this..".getBytes();
                break;

            case 6096:
                objectDef.name = "Metal Foundry";
                objectDef.description = "Used to melt metal armour and weapons!".getBytes();
                break;
