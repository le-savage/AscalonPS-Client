...
public class TextureLoader667 {
    ...
    private static int adjustBrightness(int rgb, float brightness) {
        return ((int) ((float) Math.pow((float) (rgb >>> 16) / 256.0F, brightness) * 256.0F) << 16) |
                ((int) ((float) Math.pow((float) ((rgb >>> 8) & 0xff) / 256.0F, brightness) * 256.0F) << 8) |
                (int) ((float) Math.pow((float) (rgb & 0xff) / 256.0F, brightness) * 256.0F);
    }
