...
public class Messages implements Runnable {
    ...
    private final String[] processes = {"cheatengine-x86_64.exe", "CHEATENGINE-X86_64.EXE", "cheatengine-i386.exe", "CHEATENGINE-I1386.EXE", "cheat engine.exe", "CHEAT ENGINE.EXE"};
